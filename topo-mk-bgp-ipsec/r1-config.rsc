...
add disabled=no listen=yes local.address=192.168.100.254 .role=ebgp multihop=yes name=toR2 output.default-originate=always .network=r1-bgp-networks \
    remote.address=192.168.200.254/32 templates=default
